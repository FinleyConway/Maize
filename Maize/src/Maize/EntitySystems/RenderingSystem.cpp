#include "Maize/EntitySystems/RenderingSystem.h"
...
namespace Maize {
    ...
    */
    ...
    void RenderingSystem::RenderSprite(const SpriteRenderData& renderData, const CameraData& cameraData)
    {
        ...
        Application::Get().GetRenderer().RenderSprite(spriteData->Tex(), spriteData->Position(), spriteScreenPos, spriteTransform.angle, spriteData->Pivot(), flip);
    }
